...
<template>
  <div class="mt-[80px] uppercase  desktop:mb-[30px] desktop:mx-[30px] mx-[20px] leading-10 mb-[15px] pr-[45px] font-TT font-bold text-[40px]">
  ...
  <swiper @swiper="onSwiper" :watchSlidesProgress="true" :slides-per-view="isDesktop ? 4 : 2.2" :modules="modules"
    ...
    <swiper-slide v-for="(cover, index) in covers" @click="openPdf(App.language == 'ru' ? cover?.pdf_ru : cover?.pdf_eng)" :class="[index === 0 ? '' : 'border-l-transparent desktop:border-l-transparent']"
      ...
      <div class="desktop:text-sm h-[16px] text-xs uppercase desktop:mt-2 mt-[20px]">
