...
<template>
  <div
    class="desktop:mt-[80px] mt-[40px] desktop:mb-[30px] desktop:mx-[30px] mx-[20px] leading-10 mb-[15px] font-TT font-bold desktop:text-[40px] text-[32px]"
  >
  ...
  >
    ...
    >
      <img
        :src="cover?.image"
        class="w-full bg-[#EDEDED] p-[10px] flex justify-center aspect-[137/145]"
      />
      <div
        class="desktop:text-[12px] h-[16px] uppercase desktop:mt-2 mt-[20px]"
      >
