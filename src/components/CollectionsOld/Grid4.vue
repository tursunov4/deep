...
<template>
  ...
  <div @click="router.push({ path: '/sub-category/' + sub_categories[0 + offset].eng_name, query: { collection: collectionId } })" class="cursor pointer relative p-4 flex items-end aspect-[3/1] desktop:aspect-square">
  ...
  <div @click="router.push({ path: '/sub-category/' + sub_categories[1 + offset].eng_name, query: { collection: collectionId } })" class="cursor pointer relative p-4 flex items-end aspect-[3/1] desktop:aspect-square">
  ...
  <div @click="router.push({ path: '/sub-category/' + sub_categories[2 + offset].eng_name, query: { collection: collectionId } })" class="cursor pointer relative col-span-2 aspect-[3/1] desktop:aspect-[2/1] p-4 flex items-end">
