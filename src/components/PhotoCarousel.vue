...
<template>
  <div
    v-if="showZoom"
    class="absolute z-20 w-full flex flex-col bg-white mt-[-220px] right-0"
  >
    <div class="h-[100vh]">
      <div
        class="font-TT text-[1vw] font-bold flex justify-center items-center mt-[3vh]"
      >
        <div class="mb-[3vh]">
        ...
        <div
          ...
          class="close absolute right-0 mt-[-3.7vh] mr-[3vh]"
        ></div>
      </div>
      <div class="w-full h-[88vh]">
        ...
        >
          <swiper-slide v-for="image in images"
            ><img class="h-full mx-auto" :src="image.photo" />
          </swiper-slide>
        </swiper>
      </div>
    </div>
  ...
  <div class="w-full h-full flex justify-between gap-[1.65vw] -ml-[5px]">
    <div class="-mt-[4px] overflow-x-visible">
      ...
      >
        <swiper-slide
          ...
          ><img
            :class="{ 'border-black border-[1px]': selectedImage == index }"
    ...
    >
      <swiper-slide v-for="image in images">
        <div
          @click="showZoom = true"
          class="overflow-hidden hover:cursor-crosshair w-full h-full"
        >
          <img class="object-cover h-full w-full" :src="image.photo" />
        </div>
      </swiper-slide>
    </swiper>
  </div>
