...
const Collections = () => import("../components/Collections/CollectionsPage.vue")
...
const DoorProduct = () => import("../components/DoorProductPage/DoorProductPage.vue")
...
const Inspirations = () => import("../components/Inspiration/InspirationsPage.vue")
const Inspiration = () => import("../components/Inspiration/InspirationPage.vue")
const routes =[
    {path: '/', component: HomePage},
    {path:'/accessories', component: Accessories},
    {path: '/sub-category/:id', component: SubCategory, props: { collection: '', sales: false, color: ''}},
    ...
    {path: '/inspiration/:id', name:'inspiration-page' , component: Inspiration},
]
